...
bool OFDProcess::createPublicRes_xml()
{
    ...
    writer.writeAttribute("FontName", QStringLiteral("黑体"));
    writer.writeAttribute("ID", "1");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("隶书"));
    writer.writeAttribute("ID", "2");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("等线 Light"));
    writer.writeAttribute("ID", "3");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("等线"));
    writer.writeAttribute("ID", "4");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("楷体"));
    writer.writeAttribute("ID", "5");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("方正舒体"));
    writer.writeAttribute("ID", "6");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("方正姚体"));
    writer.writeAttribute("ID", "7");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("新宋体"));
    writer.writeAttribute("ID", "8");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("微软雅黑 Light"));
    writer.writeAttribute("ID", "9");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("微软雅黑"));
    writer.writeAttribute("ID", "10");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("幼圆"));
    writer.writeAttribute("ID", "11");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("宋体"));
    writer.writeAttribute("ID", "12");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文隶书"));
    writer.writeAttribute("ID", "13");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文行楷"));
    writer.writeAttribute("ID", "14");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文细黑"));
    writer.writeAttribute("ID", "15");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文琥珀"));
    writer.writeAttribute("ID", "16");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文楷体"));
    writer.writeAttribute("ID", "17");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文新魏"));
    writer.writeAttribute("ID", "18");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文彩云"));
    writer.writeAttribute("ID", "19");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文宋体"));
    writer.writeAttribute("ID", "20");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文仿宋"));
    writer.writeAttribute("ID", "21");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("华文中宋"));
    writer.writeAttribute("ID", "22");

    writer.writeEmptyElement("ofd:Font");                           //Font标签开始
    writer.writeAttribute("FontName", QStringLiteral("仿宋"));
